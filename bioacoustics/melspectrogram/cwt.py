...
from .signal import hertz_to_mel, mel_to_hertz
from jax import lax
...
def melspec_params(
  ...
  range_ = map(hertz_to_mel, (lower_edge_hertz, upper_edge_hertz))  # pytype: disable=wrong-arg-types  # jax-ndarray
  bands = mel_to_hertz(jnp.linspace(*range_, num_mel_bins + 2))
